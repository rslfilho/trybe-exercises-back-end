...
SELECT 'This is SQL Exercise, Practice and Solution' AS `exercise_1`;
...
SELECT 1287 / 34 AS `randon_arithimetic`;
...
SELECT 
    CONCAT('O projeto ',
            ...
            ' precisou de ',
            Hours,
            ' horas para ser concluído.') AS `Frase`
FROM
    Scientists.Projects;
...
SELECT 
    CONCAT('Existem ',
            COUNT(*),
            ' cientistas na tabela Scientists.') AS `frase`
FROM
    Scientists.Scientists;
